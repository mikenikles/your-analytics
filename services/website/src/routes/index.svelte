    ...
    <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
      ...
      <div class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
        <div class="relative">
          ...
          <p class="mt-3 text-lg leading-7 text-gray-500">
            How many unique visitors did your website have and how many pages did these visitors view?
          </p>
        ...
        <div class="mt-10 -mx-4 relative lg:mt-0">
          <p>TODO: Insert live visitors stats for your-analytics.org</p>
        </div>
      </div>
      ...
      <div class="relative mt-12 sm:mt-16 lg:mt-24">
        <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div class="lg:col-start-2">
            ...
            <p class="mt-3 text-lg leading-7 text-gray-500">
              Learn which pages on your website are most and least popular.
            </p>
          ...
          <div class="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
            <p>TODO: Insert top pages for your-analytics.org</p>
          </div>
        </div>
      </div>
      ...
      <div class="relative mt-12 sm:mt-16 lg:mt-24">
        <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div class="lg:col-start-2">
            ...
            <p class="mt-3 text-lg leading-7 text-gray-500">
              Learn which other websites refer visitors to you.
            </p>
          ...
          <div class="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
            <p>TODO: Insert top referrers for your-analytics.org</p>
          </div>
        </div>
      </div>
      ...
      <div class="relative mt-12 sm:mt-16 lg:mt-24">
        <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
          <div class="lg:col-start-2">
            ...
            <p class="mt-3 text-lg leading-7 text-gray-500">
              Learn what devices your visitors use (i.e. operating system, browser and device type).
            </p>
          ...
          <div class="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
            <p>TODO: Insert devices for your-analytics.org</p>
          </div>
        </div>
      </div>
      ...
      <div class="relative mt-12 sm:mt-16 lg:mt-24">
        <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
          ...
          <div class="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
            <p>TODO: Insert world map for your-analytics.org</p>
          </div>
        </div>
      </div>
    </div>
