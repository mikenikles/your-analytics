      ...
      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="py-8 px-4 sm:px-10">
          <form on:submit|preventDefault={handleSubmit}>
            <fieldset disabled={isSiteAdded}>
              ...
              <div class="mt-6">
                ...
                {#if isUrlInvalid}
                  <p class="mt-2 text-sm text-red-600" id="url-error">You already configured this website</p>
                {/if}
              </div>
          ...
          {#if isSiteAdded}
            ...
            <p class="mt-6">Once added, please refresh <a href="https://{url}" target="_blank" rel="noopener">{url}</a> to see the first visit logged below.</p>
            <div class="relative mt-6">
