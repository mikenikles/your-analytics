  ...
  <div class="max-w-4xl mx-auto">
    <div class="py-10 px-4 sm:py-32 sm:px-12">
      ...
      <div class="mt-8 justify-center sm:flex">
        <a href="/onboarding" sveltekit:prefetch class="w-full items-center inline-flex justify-center py-4 px-10 bg-blue-600 rounded-lg font-semibold sm:w-auto">
          Get Started
        </a>
        <a href="/your-analytics.org" sveltekit:prefetch class="mt-4 w-full items-center inline-flex justify-center py-4 px-10 bg-white rounded-lg font-semibold text-black sm:mt-0 sm:ml-4 sm:w-auto">
